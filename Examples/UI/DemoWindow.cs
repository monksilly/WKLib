...
public static class DemoWindow
{
    ...
    private static readonly DemoTreeNode[] treeNodes = new[]
    {
        new DemoTreeNode("Node 0",
                           new DemoTreeNode("Node 1"),
                           new DemoTreeNode("Node 2")),
        new DemoTreeNode("Node 3"), new DemoTreeNode("Node 4",
                                                         new DemoTreeNode("Node 5",
                                                                            new DemoTreeNode("Node 6"),
                                                                            new DemoTreeNode("Node 7")))
    };
    ...
    private static void DrawSlidersDemo(ImGui gui)
    {
        ...
        gui.Slider(ref bouncingBallSize, 1f, gui.GetRowHeight());
